...
struct Point: Hashable{
    ...
    let y: Int
    let dir: Int
    init(_ x:Int, _ y: Int, _ dir: Int){
        self.x = x
        self.y = y
        self.dir = dir
    }
...
struct Light{
    let p: Point
    var mirrors: Set<Point>
    var visited: Set<Point>
    init(_ p: Point, _ mirrors: Set<Point>, _ visited: Set<Point>){
        self.p = p
